...
**Architectural invariant:** If untrusted input were structurally separated from system instructions before processing, 20 PI attacks + 8 MT attacks + 8 VE attacks (36 of 168 total, 21%) would be eliminated by design.
