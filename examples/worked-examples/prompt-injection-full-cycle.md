...
**Architectural invariant:** If untrusted input were structurally separated from system instructions before processing, 20 PI attacks + 10 MT attacks + 10 VE attacks (40 of 168 total, 24%) would be eliminated by design.
